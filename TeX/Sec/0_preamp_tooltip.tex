...
\newcommand{\repeatable}[2]{ \label{#1}\global\@namedef{repeatable@#1}{#2}#2 }

\newcommand{\eqrepeat}[1]{ \@ifundefined{repeatable@#1}{NOT FOUND}{${\scriptstyle\@nameuse{repeatable@#1}}$} }

\newcommand{\tooltipref}[1]{\eqref{#1}\tooltip[black]{\hspace{-2pt}$^{\scriptstyle ?}$\hspace{-2pt}}[white]{\eqrepeat{#1}} }
